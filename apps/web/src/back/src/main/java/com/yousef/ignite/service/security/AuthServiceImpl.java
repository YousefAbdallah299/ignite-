...
//        emailService.sendVerificationEmail(user);
    ...
    public void deleteUser(String bearerToken, Long userId) {
        ...
        candidateProfileRepository.findByUser(targetUser).ifPresent(candidateProfile -> {
            ...
            // IMPORTANT: Do not delete the profile explicitly here.
            // `userRepository.delete(targetUser)` will cascade-remove the candidate profile.
            // Double-deleting can cause StackOverflowError / detached instance issues.
        });
        ...
        recruiterProfileRepository.findByUser(targetUser).ifPresent(recruiterProfile -> {
            ...
            // IMPORTANT: Do not delete the recruiter profile explicitly here.
            // `userRepository.delete(targetUser)` will cascade-remove the recruiter profile.
            // Double-deleting can produce "Removing a detached instance RecruiterProfile..." errors.
        });
